...
export const SecondPage = () => {
    return (
        <section id='reverse-dir' style={{ backgroundImage: `url(${bg})` }} className='full-w full-h flex flex-col justify-start p-2 relative lg:flex-row lg:justify-between flip'>
